  ...
  return (
    <main className="min-h-screen bg-background text-foreground pb-16">
      ...
      <div className="max-w-4xl mx-auto pt-16 pb-20">
        <h1 className="text-4xl font-bold mb-10 text-center text-foreground">Analytics</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-card border-2 border-border rounded-lg p-8 text-center shadow-lg transition-colors duration-200 group hover:border-primary">
            <h2 className="text-2xl font-semibold mb-2 group-hover:text-primary transition-colors duration-200">Total Songs</h2>
            <p className="text-5xl font-bold text-foreground">{songCount !== null ? songCount : "-"}</p>
          </div>
          <div className="bg-card border-2 border-border rounded-lg p-8 text-center shadow-lg transition-colors duration-200 group hover:border-primary">
            <h2 className="text-2xl font-semibold mb-2 group-hover:text-primary transition-colors duration-200">Unique Singers</h2>
            <p className="text-5xl font-bold text-foreground">{singerCount !== null ? singerCount : "-"}</p>
          </div>
          <div className="bg-card border-2 border-border rounded-lg p-8 text-center shadow-lg transition-colors duration-200 group hover:border-primary">
            <h2 className="text-2xl font-semibold mb-2 group-hover:text-primary transition-colors duration-200">Maloof Entries</h2>
            <p className="text-5xl font-bold text-foreground">{maloofEntryCount}</p>
          </div>
          <div className="bg-card border-2 border-border rounded-lg p-8 text-center shadow-lg transition-colors duration-200 group hover:border-primary">
            <h2 className="text-2xl font-semibold mb-2 group-hover:text-primary transition-colors duration-200">Fully Written Songs <span className="block text-base group-hover:text-primary transition-colors duration-200">(مكتوبة كاملة)</span></h2>
          ...
          >
            <h2 className="text-2xl font-semibold mb-2 group-hover:text-primary transition-colors duration-200">Songs with Only Beginning Written <span className="block text-base group-hover:text-primary transition-colors duration-200">(مطلع الأغنية/رأس البيت فقط)</span></h2>
          ...
          <Link 
            ...
            className="bg-card border-2 border-primary rounded-lg p-8 text-center shadow-lg transition-all duration-200 group hover:border-primary/80 hover:bg-muted cursor-pointer"
          >
            <h2 className="text-2xl font-semibold mb-2 group-hover:text-primary transition-colors duration-200">Songs Not Yet Written <span className="block text-base group-hover:text-primary transition-colors duration-200">(الكلمات غير موجودة)</span></h2>
