          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-muted border border-border rounded-lg p-4">
                <label htmlFor="name" className={`block text-sm font-medium text-foreground mb-2 ${language === 'ar' ? 'text-center md:text-right' : ''}`}>
                  {t('name')}
                </label>
                <Input
                  type="text"
              ...
              <div className="bg-muted border border-border rounded-lg p-4">
                <label htmlFor="email" className={`block text-sm font-medium text-foreground mb-2 ${language === 'ar' ? 'text-center md:text-right' : ''}`}>
                  {t('email')}
                </label>
                <Input
                  type="email"
            ...
            <div className="bg-muted border border-border rounded-lg p-4">
              <label htmlFor="subject" className={`block text-sm font-medium text-foreground mb-2 ${language === 'ar' ? 'text-center md:text-right' : ''}`}>
                {t('subject')}
              </label>
              <Input
                type="text"
            ...
            <div className="bg-muted border border-border rounded-lg p-4">
              <label htmlFor="message" className={`block text-sm font-medium text-foreground mb-2 ${language === 'ar' ? 'text-center md:text-right' : ''}`}>
                {t('message')}
              </label>
              <Textarea
                id="message"
